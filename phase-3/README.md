...
│   │   ├── chat.py       # AI chat endpoint (10-step cycle)
...
This is Phase 3 of a hackathon project. Previous phases:
- **Phase 1**: Basic project setup
- **Phase 2**: Full-stack Todo app with JWT auth, task CRUD, Next.js dashboard
- **Phase 3 (this)**: AI chat integration with Groq LLaMA, MCP tool server, conversation history
