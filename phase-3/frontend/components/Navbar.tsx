  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-50 border-b border-gray-200 bg-white">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6">
        ...
        {/* Right: user name + chat link + logout */}
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <Link
            href="/chat"
            className="rounded-lg px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
          >
            💬 Chat
          </Link>
          <button
